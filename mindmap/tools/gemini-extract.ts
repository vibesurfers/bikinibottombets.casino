...
const EXTRACTION_PROMPT = `You are an expert at extracting structured knowledge graph data from text.
...
export const geminiExtractTool = createTool({
  id: 'gemini-extract',
  description: 'Use Gemini 2.0 Flash to extract actors and connections from text. Returns structured JSON.',
  inputSchema: z.object({
    text: z.string().describe('Text to extract actors and connections from'),
    focusActor: z.string().optional().describe('Actor name to focus extraction around'),
  }),
